...
class WorkspaceViewController: PopHandlerViewController {
    ...
    private var currentTab: Int = 0 // 0 = Graph Chat, 1 = Features, 2 = Tasks, 3 = Pods
    ...
    private func setupSegmentedControls() {
        ...
        topTabSegmentedControl.configureFromOutlet(
            buttonTitles: ["GRAPH CHAT", "FEATURES", "TASKS", "PODS"],
            initialIndex: 0,
            delegate: self
        )
...
extension WorkspaceViewController: CustomSegmentedControlDelegate {
    ...
    private func switchToTab(_ index: Int) {
        currentTab = index
        createFeatureButton.isHidden = (index == 0 || index == 3)
