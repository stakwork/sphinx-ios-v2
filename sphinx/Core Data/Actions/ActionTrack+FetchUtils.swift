...
extension ActionTrack {
    ...
    public enum SortDescriptors {
        ...
        public nonisolated(unsafe) static let typeAscending: NSSortDescriptor = NSSortDescriptor(
        ...
        public nonisolated(unsafe) static let typeDescending: NSSortDescriptor = {
