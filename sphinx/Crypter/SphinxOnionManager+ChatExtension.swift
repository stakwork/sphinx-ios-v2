    ...
    func processNewOutgoingMessage(
        ...
        for msg in rr.msgs {
            ...
            if msgType == TransactionMessage.TransactionMessageType.delete.rawValue {
                guard let replyUUID = replyUUID, let messageToDelete = TransactionMessage.getMessageWith(uuid: replyUUID, context: context) else {
                    return nil
                }
...
//    func assignReceiverId(
//        localMsg: TransactionMessage,
//        context: NSManagedObjectContext? = nil
//    ) {
//        var receiverId :Int = -1
//        
//        if let contact = localMsg.chat?.getContact(context: context) {
//            receiverId = contact.id
//        } else if localMsg.type == TransactionMessage.TransactionMessageType.boost.rawValue,
//            let replyUUID = localMsg.replyUUID,
//                  let replyMsg = TransactionMessage.getMessageWith(uuid: replyUUID, context: context)
//        {
